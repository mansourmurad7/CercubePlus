...
- For AltStore user:
  ...
  - [Open in AltStore (v17.17.4-5.3.9)](https://tinyurl.com/2p84s282) - It will take a while to install because AltStore needs to download the IPA.

- Version info: _(May 02)_
