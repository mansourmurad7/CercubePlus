...
- For AltStore user:
  ...
  - [Open in AltStore (v17.23.6-5.3.9)](https://tinyurl.com/mt86pjfc) - It will take a while to install because AltStore needs to download the IPA.

- Version info: _(June 14)_
